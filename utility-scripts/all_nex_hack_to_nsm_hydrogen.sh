...
hydro_rh_to_nsm(){
    ...
    # trash and remove hydrogen Nex-Hack client
...
executable=hydrogen
config_file="\$NEX_SESSION_NAME.h2song"
...
hydro_nsm_templates=$(nex_control list_factory_client_templates executable:$executable protocol:NSM)
